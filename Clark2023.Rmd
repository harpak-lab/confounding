...
fig_s8a <- fig_s8_dat %>% 
  ...
  ggplot(aes(x=n, y=cov, colour=data, group=relationship_rename))+
  geom_point(size=3)+
  geom_line(linetype="dashed", colour="black")+
  # geom_abline(alpha=0.5)+
  theme_clark()+
  geom_text_repel(data=fig_s8_dat %>% dplyr::filter(data=="unique individuals"),
                  aes(label=relationship_rename),
                  colour="black",
                  nudge_x=2, nudge_y=5)+
...
fig_s8b <- fig_s8_dat %>% 
  #pivot_wider(values_from=cov, names_from=gp) %>% 
  ggplot(aes(x=n, y=var0, colour=data, group=relationship_rename))+
  geom_point(size=3)+
  geom_line(linetype="dashed", colour="black")+
  # geom_abline(alpha=0.5)+
  theme_clark()+
